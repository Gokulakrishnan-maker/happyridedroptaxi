      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold text-gray-800 mb-4">Tariff Details</h2>
          ...
          <div className="mb-12">
            <div className="flex items-center justify-center mb-6">
              ...
              <h3 className="text-2xl font-bold text-gray-800">One Way Tariff</h3>
            </div>
              ...
              <table className="w-full bg-white rounded-lg shadow-lg border border-gray-200">
                ...
                <tbody className="text-gray-700">
                  <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    <td className="px-6 py-4 font-semibold">SEDAN</td>
                    <td className="px-6 py-4">₹14/KM</td>
                    <td className="px-6 py-4">₹400</td>
                    <td className="px-6 py-4">One way Toll</td>
                  </tr>
                  <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    <td className="px-6 py-4 font-semibold">ETIOS</td>
                    <td className="px-6 py-4">₹14/KM</td>
                    <td className="px-6 py-4">₹400</td>
                    <td className="px-6 py-4">One way Toll</td>
                  </tr>
                  <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    <td className="px-6 py-4 font-semibold">SUV</td>
                    <td className="px-6 py-4">₹19/KM</td>
                    <td className="px-6 py-4">₹400</td>
                    <td className="px-6 py-4">One way Toll</td>
                  </tr>
                  <tr className="hover:bg-gray-50 transition-colors">
                    <td className="px-6 py-4 font-semibold">INNOVA</td>
          ...
          <div className="mb-8">
            <div className="flex items-center justify-center mb-6">
              ...
              <h3 className="text-2xl font-bold text-gray-800">Round Trip Tariff</h3>
            </div>
            <div className="overflow-x-auto">
              <table className="w-full bg-white rounded-lg shadow-lg border border-gray-200">
          ...
          <div className="text-center bg-white rounded-xl p-8 shadow-lg">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-6">
              ...
              <button
                ...
                className="inline-flex items-center px-6 py-3 border-2 border-blue-600 text-blue-600 rounded-lg hover:bg-blue-600 hover:text-white transition-all duration-300 font-semibold"
              >
